...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.CreateConnectSessionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/mailboxes/connect-sessions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.ConnectSession$inboundSchema),
