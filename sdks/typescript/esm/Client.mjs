...
export class MailmonClient {
    ...
    __getV1MailboxesByMailboxId(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/mailboxes/{mailboxId}");
        });
    }
    /**
    ...
    __getV1MailboxesByMailboxIdObservability(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/mailboxes/{mailboxId}/observability");
        });
    }
    /**
    ...
    __getV1ReplaysByReplayId(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/replays/{replayId}");
        });
    }
    /**
    ...
    __getV1MessagesByMessageId(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/messages/{messageId}");
        });
    }
    /**
    ...
    __getV1ThreadsByThreadId(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/threads/{threadId}");
        });
    }
    /**
