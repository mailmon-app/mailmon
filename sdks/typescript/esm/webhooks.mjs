...
export const verifySignature = (payload, signatureHeader, secret, options = {}) => {
...
export const constructEvent = (payload, signatureHeader, secret, options = {}) => {
    ...
    try {
        ...
        throw new MailmonWebhookSignatureError(
            error instanceof Error ? `Webhook payload is not valid JSON: ${error.message}` : "Webhook payload is not valid JSON.",
        );
    }
};
