...
```typescript
import { Lease } from "@mailmon.dev/sdk/models";
...
| ------------------------ | --------------------------------------------------------------------------------------------- | ------------------ | ----------- |
| `activeLeaseOwner`       | _string_                                                                                      | :heavy_check_mark: | N/A         |
...
| `contentionCount24h`     | _number_                                                                                      | :heavy_check_mark: | N/A         |
...
| `leaseLossCount24h`      | _number_                                                                                      | :heavy_check_mark: | N/A         |
