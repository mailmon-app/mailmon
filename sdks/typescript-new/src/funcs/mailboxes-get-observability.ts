...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.MailboxesGetObservabilityRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MailboxObservability$inboundSchema),
