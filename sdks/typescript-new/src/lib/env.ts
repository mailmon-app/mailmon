...
export interface Env {
  MAILMON_BEARER_AUTH?: string | undefined;

  MAILMON_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  MAILMON_BEARER_AUTH: z.optional(z.string()),

  MAILMON_DEBUG: z.optional(z.coerce.boolean()),
});
