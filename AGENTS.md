...
- Mailbox sync state writes are now lease-aware, and the worker heartbeats the mailbox lease across the full sync critical section so stale leases can be taken over safely.
