...
export function getV1MailboxesByMailboxIdObservability(
  ...
  Result<
    ...
    | errors.GetV1MailboxesByMailboxIdObservabilityBadRequestError
    | errors.GetV1MailboxesByMailboxIdObservabilityNotFoundError
    | MailmonError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1MailboxesByMailboxIdObservabilityRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/mailboxes/{mailboxId}/observability")(
    pathParams,
  );
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors
        .GetV1MailboxesByMailboxIdObservabilityBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.GetV1MailboxesByMailboxIdObservabilityNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
