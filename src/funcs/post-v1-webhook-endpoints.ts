 ...
 */
export function postV1WebhookEndpoints(
  client: MailmonCore,
  ...
  Result<
    ...
    | errors.PostV1WebhookEndpointsBadRequestError
    | MailmonError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PostV1WebhookEndpointsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/webhook-endpoints")();
  ...
  >(
    ...
    M.jsonErr(400, errors.PostV1WebhookEndpointsBadRequestError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
