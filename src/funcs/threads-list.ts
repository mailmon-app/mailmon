...
export function threadsList(
  ...
  PageIterator<
    Result<
      operations.ThreadsListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ThreadsListRequest$outboundSchema, value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ThreadsListResponse$inboundSchema, {
      key: "Result",
    }),
