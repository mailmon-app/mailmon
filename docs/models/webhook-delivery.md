...
| `deliveryState`                                                                                        | [models.MailboxObservabilityDeliveryState](../models/mailbox-observability-delivery-state.md)          | :heavy_check_mark:                                                                                     | N/A                                                                                                    |
...
| `lastDeliveryError`                                                                                    | [models.MailboxObservabilityLastDeliveryError](../models/mailbox-observability-last-delivery-error.md) | :heavy_check_mark:                                                                                     | N/A                                                                                                    |